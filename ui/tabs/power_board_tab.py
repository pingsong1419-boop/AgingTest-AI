...
class PowerBoardTab(QWidget):
    ...
    def _init_ui(self):
        ...
        self.edit_ip = QLineEdit("192.168.1.202")
        ...
        self.lbl_volt.setStyleSheet("font-size: 30px; color: #FFEB3B; font-weight: bold;")
        read_layout.addWidget(self.lbl_volt, 0, 1)
        
        read_layout.addWidget(QLabel("实时电流:"), 1, 0)
        self.lbl_curr = QLabel("0.00 A")
        self.lbl_curr.setStyleSheet("font-size: 30px; color: #8BC34A; font-weight: bold;")
